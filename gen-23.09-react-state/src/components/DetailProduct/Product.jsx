  ...
  return (
    <div className="flex flex-col gap-4 w-5/12">
          ...
          <div className="flex gap-4" id="button">
            <button className="flex transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 bg-color1 hover:bg-color1 w-10 h-10 rounded-lg justify-center items-center">
              <p>XS</p>
            </button>
            <button className="flex transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 bg-color1 hover:bg-color1 w-10 h-10 rounded-lg justify-center items-center">
              <p>L</p>
